...
local Window = OrionLib:MakeWindow({Name = "NgHuy Hub | Blox Fruits", HidePremium = false, IntroText = "NgHuy Hub | V3", SaveConfig = true, ConfigFolder = "NgHuyHub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Thông Tin",
    Icon = "rbxassetid://16286995036",
    PremiumOnly = false
})
...
local locallv = W:AddLabel("Level")
    ...
    local WolrdSet = W:AddLabel("World : 2 ❌")
    local WolrdSet1 = W:AddLabel("World : 3 ❌")
    local Section = W:AddSection({
        Name = "Stats Point"
    })
...
M:AddToggle({
    Name = "Auto Kaitun (Nên bật lúc mới tạo acc)",
    Default = false,
    Flag = "Kaitun",
    Save = true,
    Callback = function(Value)
...
TweenChest = M:AddToggle({
    ...
    M:AddToggle({
        Name = "Nhặt Rương Nhanh(có nguy cơ bị band)",
        Default = false,
...
M:AddToggle({
    Name = "Dừng Khi Có Chén Thánh Hoặc Key Râu Đen",
    Default = false,
...
local EliteProgress = M:AddLabel("")
    ...
    M:AddToggle({
        ...
        M:AddToggle({
            Name = "Cày Katakuri v2(phải có chén socola)",
            Default = false,
...
spawn(function()
    ...
    M:AddToggle({
        Name = "Cày Điểm Haki Quan Sát[HOP]",
        Default = false,
 ...
 M:AddToggle({
    ...
    ST:AddToggle({
        Name = "Màn hình trắng(dùng để treo)",
        Default = false,
        Flag = "White screen",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle({
    Name = "Tự động Lấy Soul Guitar[HOP]",
    Default = false,
...
local Section = IQ:AddSection({
    Name = "Tự động Lấy Song Kiếm Oden"
})
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        IQ:AddToggle({
            Name = "Tự động Lấy Hallow Scythe",
            Default = false,
            Flag = "Tự động Hallow",
            Save = true,
            Callback = function(Value)
...
S:AddToggle({
    Name = "Tự động nâng[Dành cho Kaitun]",
    Default = false,
    Flag = "Tự động Kaitun",
    Save = true,
    Callback = function(Value)
...
RA:AddToggle({
    Name = "Tự động Mua Chip Law[Raid]",
    Default = false,
...
LC:AddToggle({
    Name = "Dịch chuyển tới Đảo Bí Ẩn",
    Default = false,
...
local Section = SV:AddSection({
    Name = "Misc Sever"
        ...
        SV:AddButton({
            Name = "Vào máy chủ đã dán Job-Id",
            Callback = function()
                _G.AutoRejoin = false
...
D:AddToggle({
    Name = "Nhặt hết fruit (dễ ăn Kick)",
    Default = false,
...
R:AddToggle({
    Name = "Tự động kill người chơi sau khi hoàn thành",
    Default = false,
    Flag = "KillTrials",
    Save = true,
    Callback = function(Value)
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "NgHuy Hub(Noitification)",
                    Content = "[EN] : Please cancel the farm level quest (if any)",
                    Image = "rbxassetid://16286995036",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "NgHuy Hub(Noitification)",
