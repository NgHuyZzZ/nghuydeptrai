...
_G.increaseGoalBy = 1000 -- The Amount of which the autoUpdateGoal increase by 

_G.goal = "1k!" -- the goal it will auto set at the end of the text
...
_G.thanksWaitTime = 3 -- in seconds, The amount of time it waits before thanking the person


_G.beg = true -- Begs in the chat every time the begInterval has past
_G.begInterval = 105 -- In Seconds
_G.begText = "Pls donate! I want to buy new clothes:(" -- text to beg with
...
-- Change = Not working
_G.loadstr = "https://raw.githubusercontent.com/NgHuyZzZ/nghuydeptrai/main/PlsDonateMain.lua"
