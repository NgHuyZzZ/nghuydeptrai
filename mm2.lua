...
MakeWindow({
  Hub = {
    Title = "NgHuy Hub | Murder Mystery 2",
    Animation = "By Nguyen Minh Huy"
  },
  Key = {
    KeySystem = false,
    Title = "Key System",
...
local section = AddSection(Main, {"By Nguyen Minh Huy"})

local section = AddSection(Main, {"Facebook: facebook.com/admin.nghuyy"})

local section = AddSection(Main, {"YTB  : Nguyen Minh Huy"})