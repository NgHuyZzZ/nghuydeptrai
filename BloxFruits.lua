...
mainopens.Parent = mainopen
 ...
 loki.Image = "rbxassetid://16286995086"
 ...
 local uihide = false
 local abc = false
 local logo = logo or 16286995086
 local currentpage = ""
...
--------------------------------------------------------------------
local Library = Update:Window("NgHuy Hub ","")
------------------------------------------
...
Setting:Button("Copy Discord Link",function()
 ...
 setclipboard("https://discord.gg/B2tSQPTnJe")
 end)
...
wait(1)
Notification:Notify(
   {Title = "NgHuy Hub", Description = "You Have Max Observation"},
