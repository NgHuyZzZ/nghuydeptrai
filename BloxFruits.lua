...
ImageButton1.Image = "rbxassetid://16286995036"
...
local Library = Update:Window("NgHuy Hub","",Enum.KeyCode.RightControl);
...
local R = Library:AddTab("Raid","4483345998")
...
repeat wait() until game:IsLoaded() 
	...
	Misc:AddTextbox("Lock Fragment", "Please Type", true, function(value)
